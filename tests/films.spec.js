...
describe('Function "moviesAverageByCategory"', () => {
  ...
  it('should return a number', () => {
    expect(typeof moviesAverageByCategory(testData, 'Drama')).toBe('number');
  });
  it('should be different from NaN', () => {
    expect(moviesAverageByCategory(testData, 'Drama')).not.toBeNaN();
  });
  it('should calculate the average by category', () => {
    expect(moviesAverageByCategory(testData, 'Drama')).toBe(7);
  });
});
